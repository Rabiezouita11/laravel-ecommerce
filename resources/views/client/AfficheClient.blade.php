            ...
            <tbody>
              ...
              <tr>
                  ...
                  <td>
                    ...
                    <a class="btn btn-success" href="{{route('AfficheEditClient',['id'=>$user->id])}}" role="button">edit</a>
                    <a class="btn btn-danger" href="{{route('AfficheDeleteClient',['id'=>$user->id])}}" role="button">supprimer</a>
              ...
              @endforeach
              <a class="btn btn-primary" href="{{route('AfficheAjoutClient')}}" role="button">ajouter client</a>
            </table>
