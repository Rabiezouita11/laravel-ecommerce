...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <body>
        @if (request()->input())
        <h6>{{$produits->total()}} resultat(s) pour la recherche "{{request()->a}}"</h6>
        @endif
        <table class="table table-striped table-dark">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td> {{$produit->prix}}</td>
                <td><img src="{{asset('storage/'.$produit->image)}}" alt=" " class="img-fluid"  width="500px" height="500px"></td>
                <td> {{$produit->stock}}</td>
                <td> {{$produit->description}}</td>

                  <td>

                    <a class="btn btn-success" href="{{route('AfficheEditProduit',['id'=>$produit->id])}}" role="button">edit</a>
                    <a class="btn btn-danger" href="{{route('AfficheDeleteProduit',['id'=>$produit->id])}}" role="button">supprimer</a>
              ...
              @endforeach
              <a class="btn btn-primary" href="{{route('AfficheAjoutProduit')}}" role="button">ajouter Produit</a>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a  class="brand-link">
      <img src="{{asset('images/logo2.png')}}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light text-white" href="{{route('admin2')}}">Electro Store</span>
    </a>
