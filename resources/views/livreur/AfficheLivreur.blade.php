 ...
 <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Livreur</h1>
          </div><!-- /.col -->
          <div class="col-sm-">
            ...
            <tbody>
              ...
              <tr>
                  ...
                  <td>
                    ...
                    <a class="btn btn-success" href="{{route('AfficheEditLivreur',['id'=>$livreur->id])}}" role="button">edit</a>
                    <a class="btn btn-danger" href="{{route('AfficheDeleteLivreur',['id'=>$livreur->id])}}" role="button">supprimer</a>
              ...
              @endforeach
              <a class="btn btn-primary" href="{{route('AfficheAjoutLivreur')}}" role="button">ajouter livreur</a>
            </table>
