            ...
            <tbody>
              ...
              <tr>
                  ...
                  <td>
                    ...
                    <a class="btn btn-success" href="{{route('AfficheEditCategorie',['id'=>$categorie->id])}}" role="button">edit</a>
                    <a class="btn btn-danger" href="{{route('AfficheDeleteCategorie',['id'=>$categorie->id])}}" role="button">supprimer</a>
              ...
              @endforeach
              <a class="btn btn-primary" href="{{route('AfficheAjoutCategorie')}}" role="button">ajouter categorie</a>
            </table>
