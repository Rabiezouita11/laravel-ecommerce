		...
		<div class="container">
			<div class="row header-bot_inner_wthreeinfo_header_mid">
				...
				<div class="col-md-3 logo_agile">
                    ...
                    <a href="{{asset('/')}}" class="font-weight-bold font-italic">
...
@endforeach
            <p>
			<h1 class="display-9">votre produit va etre livrer dans le :</h1>

			<h2 class="display-9"><input class="display-9 "  value="{{$newDate}}" readonly></h2>
