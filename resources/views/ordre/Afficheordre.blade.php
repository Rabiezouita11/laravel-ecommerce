  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Ordre</h1>
          </div><!-- /.col -->
          <div class="col-sm-5">
    ...
    <body>
        ...
        <table  class="table table table-dark" >
            ...
            <tbody>
              ...
              <tr class="{{$ordre->livreur ? 'alert-success' :'alert-danger'}}" >
                  <td> {{$ordre->id}}</td>
                  <td> {{$ordre->produit}}</td>
                  <td> {{$ordre->typedepaiment}}</td>
                  <td> {{$ordre->prixtotal}}</td>
                  <?php
 $date = date_create($ordre->created_at);
 date_modify($date, '+4 day');
 $newDate=date_format($date, 'Y-m-d');
  ?>
                  <td> {{$ordre->created_at}}</td>
                  <td> {{$newDate}}</td>
                  <td> {{$ordre->user->name}}</td>
                  <td> {{$ordre->adresse}}</td>
                  <td> {{$ordre->numero}}</td>


                  <td> {{$ordre->livreur}}</td>
                  <td> {{$ordre->confirmation}}</td>
                  ...
                  <td>
                    ...
                    <a class="btn btn-info" href="{{route('Afficheordre1',['id'=>$ordre->id])}}" role="button">edit</a>
